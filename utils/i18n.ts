...
const dictionary: Record<Language, Record<TranslationKey, string>> = {
  ...
  th: {
    invoice_editor: 'แก้ไขใบแจ้งหนี้',
    lease_editor: 'แก้ไขสัญญาเช่า',
    preview: 'ดูตัวอย่าง',
    ...
    switch_chat: 'แชท',
    switch_schedule: 'ตารางเวลา',
    doc_invoice: 'A4 PDF • มาตรฐานรัสเซีย',
    doc_lease: 'A4 PDF • สัญญาเช่า',
    ai_modal_title: 'นำเข้าข้อมูลด้วย AI',
    ...
    step_counter: 'ขั้นตอนที่ {current} จาก {total}',
    btn_back: 'ย้อนกลับ',
    btn_next: 'ถัดไป',
    step_general: 'ข้อมูลทั่วไป',
    step_seller: 'ผู้ขาย (ผู้ให้บริการ)',
    step_buyer: 'ผู้ซื้อ (ลูกค้า)',
    step_goods: 'รายการสินค้าและบริการ',
    type_person: 'บุคคลธรรมดา / อาชีพอิสระ',
    type_company: 'บริษัท',
    lbl_invoice_no: 'เลขที่ใบแจ้งหนี้',
    lbl_date: 'วันที่',
    lbl_time: 'เวลา',
    lbl_vat: 'ภาษีมูลค่าเพิ่ม',
    lbl_name_fio: 'ชื่อ / ชื่อ-นามสกุล',
    ...
    lbl_director: 'ผู้อำนวยการ',
    lbl_accountant: 'สมุห์บัญชี',
    ...
    step_vehicle: 'ข้อมูลยานพาหนะ',
    step_schedule: 'ตารางเวลา',
    step_financials: 'การเงิน',
    step_parties: 'คู่สัญญาและข้อกำหนด',
    step_signatures: 'ลายเซ็น',
    lbl_res_id: 'รหัสการจอง',
    lbl_template_id: 'รหัสเทมเพลต',
    lbl_optional: 'ไม่ระบุก็ได้',
    ...
    lbl_seas_days: 'วันช่วงไฮซีซั่น',
    lbl_seas_price: 'ราคาช่วงไฮซีซั่น',
    grp_extra: 'ตัวเลือกเพิ่มเติม',
    lbl_deposit: 'เงินมัดจำ',
    lbl_total_paid: 'ยอดชำระรวม',
    grp_owner: 'เจ้าของ (ผู้ให้เช่า)',
    lbl_surname: 'นามสกุล / ชื่อ',
    lbl_contact: 'ติดต่อ',
    grp_renter: 'ผู้เช่า (ผู้ขับขี่)',
    lbl_passport: 'เลขที่หนังสือเดินทาง',
    lbl_terms: 'ข้อกำหนดทางกฎหมาย',
    ...
    preview_lease_title: 'ตัวอย่างสัญญาเช่า',
    server_preview: 'ตัวอย่างจากเซิร์ฟเวอร์',
    generating_blob: 'กำลังสร้าง PDF...',
    mobile_editor_tab: 'แก้ไข',
    mobile_preview_tab: 'ตัวอย่าง',
    open_shareable_link: 'เปิดลิงก์แชร์',
    lp_lease_agreement: 'สัญญาเช่า',
    lp_reservation_id: 'รหัสการจอง',
    lp_source: 'แหล่งที่มา',
    lp_created_on: 'สร้างเมื่อ',
    lp_pickup: 'รับรถ',
    lp_default_pickup: 'รับรถตามเวลาปกติ',
    lp_return: 'คืนรถ',
    lp_default_return: 'คืนรถตามเวลาปกติ',
    lp_rental_cost: 'ค่าเช่า',
    lp_regular_price: 'ราคาปกติ',
    lp_season_price: 'ราคาช่วงเทศกาล',
    lp_days: 'วัน',
    lp_extra_options: 'ตัวเลือกเพิ่มเติม',
    lp_none: 'ไม่มี',
    lp_deposit: 'เงินมัดจำ',
    lp_return_at_end: 'คืนเมื่อสิ้นสุดสัญญา',
    ...
    loading_conversation: 'กำลังโหลดบทสนทนา...',
    ...
    rp_map: 'แผนที่',
    rp_profile: 'โปรไฟล์',
    rp_pickup_location: 'จุดรับรถ',
    rp_map_placeholder: 'แผนที่',
    rp_leases: 'การเช่า',
    rp_status: 'สถานะ',
    rp_active: 'ใช้งานอยู่',
    rp_rider_details: 'ข้อมูลผู้ขับขี่',
    rp_full_name: 'ชื่อ-นามสกุล',
    rp_enter_name: 'กรอกชื่อ',
    rp_contact_info: 'ข้อมูลติดต่อ',
    rp_phone_email: 'โทรศัพท์หรืออีเมล',
    rp_passport_id: 'พาสปอร์ต / ID',
    rp_passport_number: 'เลขที่พาสปอร์ต',
    rp_owner_details: 'ข้อมูลเจ้าของ',
    rp_rent_service_name: 'ชื่อบริการเช่ารถ',
    ...
    status_no_response: 'ไม่ตอบกลับ',
    time_ended: 'จบแล้ว',
    time_overdue_by: 'เกินกำหนด',
    time_ending_now: 'กำลังจะจบ',
    time_ends_in: 'จบใน',
  ...
  vi: {
    ...
    lease_editor: 'Trình chỉnh sửa hợp đồng',
    preview: 'Xem trước',
    ...
    switch_schedule: 'Lịch trình',
    doc_invoice: 'A4 PDF • Tiêu chuẩn Nga',
    doc_lease: 'A4 PDF • Hợp đồng thuê xe',
    ai_modal_title: 'Nhập dữ liệu AI',
    ai_placeholder: 'Dán nội dung hóa đơn hoặc chi tiết thuê xe vào đây...',
    ...
    step_seller: 'Bên bán (Nhà cung cấp)',
    step_buyer: 'Bên mua (Khách hàng)',
    step_goods: 'Hàng hóa & Dịch vụ',
    type_person: 'Cá nhân / Tự do',
    type_company: 'Công ty',
    lbl_invoice_no: 'Số hóa đơn',
    lbl_date: 'Ngày',
    lbl_time: 'Giờ',
    lbl_vat: 'VAT',
    lbl_name_fio: 'Tên / Họ tên đầy đủ',
    lbl_inn: 'Mã số thuế',
    lbl_kpp: 'KPP',
    lbl_address: 'Địa chỉ pháp lý',
    lbl_bank_details: 'THÔNG TIN NGÂN HÀNG',
    ...
    lbl_res_id: 'Mã đặt chỗ',
    lbl_template_id: 'Mã mẫu',
    lbl_optional: 'Tùy chọn',
    lbl_source: 'Nguồn',
    lbl_created: 'Được tạo vào',
    grp_vehicle: 'CHI TIẾT XE',
    lbl_model: 'Tên mẫu xe',
    lbl_details: 'Chi tiết (Loại, Màu)',
    lbl_plate: 'Biển số',
    ...
    lbl_total_paid: 'TỔNG THANH TOÁN',
    grp_owner: 'CHỦ XE (BÊN CHO THUÊ)',
    lbl_surname: 'Họ tên',
    lbl_contact: 'Liên hệ',
    grp_renter: 'NGƯỜI LÁI (BÊN THUÊ)',
    ...
    lbl_username: 'Tên đăng nhập / Email',
    ...
    server_preview: 'Xem trước từ máy chủ',
    generating_blob: 'Đang tạo PDF...',
    mobile_editor_tab: 'Trình sửa',
    mobile_preview_tab: 'Xem trước',
    open_shareable_link: 'Mở liên kết chia sẻ',
    lp_lease_agreement: 'Hợp đồng thuê xe',
    lp_reservation_id: 'Mã đặt chỗ',
    lp_source: 'Nguồn',
    lp_created_on: 'Ngày tạo',
    lp_pickup: 'Nhận xe',
    lp_default_pickup: 'Nhận xe tiêu chuẩn',
    lp_return: 'Trả xe',
    lp_default_return: 'Trả xe tiêu chuẩn',
    ...
    no_active_chats: 'Không có cuộc trò chuyện nào.',
    loading_chats: 'Đang tải trò chuyện...',
    lbl_sort_by: 'Sắp xếp theo',
    sort_date: 'Ngày',
    sort_name: 'Tên',
    ...
    left_to_action: 'còn lại để xử lý',
    loading_conversation: 'Đang tải hội thoại...',
  ...
  id: {
    ...
    switch_lease: 'Sewa',
    switch_chat: 'Obrolan',
    switch_schedule: 'Jadwal',
    doc_invoice: 'PDF A4 • Standar Rusia',
    doc_lease: 'PDF A4 • Perjanjian Sewa',
    ai_modal_title: 'Impor Data AI',
    ai_placeholder: 'Tempel teks faktur atau detail sewa di sini...',
    ai_error: 'Tidak dapat memproses data.',
    ...
    type_person: 'Perorangan / Mandiri',
    ...
    grp_return: 'PENGEMBALIAN (AKHIR)',
    lbl_reg_days: 'Hari Biasa',
    lbl_reg_price: 'Harga Biasa',
    ...
    grp_owner: 'PEMILIK (PEMBERI SEWA)',
    ...
    lbl_sign_renter: 'Tanda Tangan Penyewa',
    btn_clear: 'Hapus',
    ...
    no_active_chats: 'Tidak ada obrolan aktif.',
    ...
    rp_map: 'Peta',
    rp_profile: 'Profil',
    rp_pickup_location: 'Lokasi Penjemputan',
    ...
    status_wait_rider: 'Tunggu Penyewa',
