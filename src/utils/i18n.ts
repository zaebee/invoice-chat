...
const dictionary: any = {
  ru: {
    ...
    btn_share_workspace: 'Поделиться',
    msg_share_copied: 'Ссылка скопирована!',
    msg_workspace_imported: 'Рабочая область импортирована',
  ...
  en: {
    ...
    btn_share_workspace: 'Share',
    msg_share_copied: 'Link copied!',
    msg_workspace_imported: 'Workspace imported',
  ...
  // Other languages omitted for brevity, fallback to EN
  th: {
    // ... existing ...
    btn_share_workspace: 'แชร์',
    msg_share_copied: 'คัดลอกลิงก์แล้ว!',
    msg_workspace_imported: 'นำเข้าพื้นที่ทำงานแล้ว',
  },
  vi: {
    // ... existing ...
    btn_share_workspace: 'Chia sẻ',
    msg_share_copied: 'Đã sao chép liên kết!',
    msg_workspace_imported: 'Đã nhập không gian làm việc',
  },
  id: {
    // ... existing ...
    btn_share_workspace: 'Bagikan',
    msg_share_copied: 'Tautan disalin!',
    msg_workspace_imported: 'Ruang kerja diimpor',
  },
};
