             ...
             <div className="pt-4 border-t border-slate-200 mt-2">
                 ...
                 {data.extraOptions.map((opt, i) => (
                     <div key={i} className="flex gap-1.5 mb-2 items-center">
                         <input 
                            className="flex-1 min-w-0 text-sm px-2.5 py-2 border border-slate-300 bg-white text-slate-900 rounded-lg focus:ring-2 focus:ring-blue-100 outline-none placeholder:text-slate-400" 
                            value={opt.name} 
                            onChange={e => updateExtraOption(i, 'name', e.target.value)} 
                            placeholder="Option Name" 
                         />
                         <input 
                            className="w-20 text-sm px-1 py-2 text-center border border-slate-300 bg-white text-slate-900 rounded-lg focus:ring-2 focus:ring-blue-100 outline-none placeholder:text-slate-400" 
                            type="number" 
                            value={opt.price} 
  ...
  const PartiesStep = (
      <div className="space-y-5">
             ...
             <div className="border-t border-slate-200 pt-4">
                ...
                <textarea 
                    className="w-full h-32 text-[10px] p-3 border border-slate-300 bg-white text-slate-900 rounded-lg font-mono focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none leading-relaxed transition-all"
                    value={data.terms}
