  ...
  return (
    <div className="bg-white shadow-lg p-8 max-w-[210mm] mx-auto min-h-[297mm] text-sm font-sans text-slate-900">
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          <div className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider border mb-3 ${statusConfig.bg} ${statusConfig.text} ${statusConfig.border}`}>
              {statusConfig.icon}
              <span>{t(statusConfig.labelKey, lang)}</span>
          </div>
