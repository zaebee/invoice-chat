                                    ...
                                    {isMenuOpen && (
                                        ...
                                        >
                                            <div className="p-1 space-y-0.5">
                                                ...
                                                <button onClick={(e) => handleMenuAction(e, 'delete', chat.id)} className="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors">
                                                    <Trash2 size={14} />
                                                    {t('btn_delete', lang)}
                                                </button>
                                            </div>
