...
export const ChatLayout: React.FC<ChatLayoutProps> = ({ leaseData, lang, leaseHandlers }) => {
    ...
    return (
        <div className="flex h-full bg-white md:rounded-xl overflow-hidden md:border border-slate-200 md:shadow-sm relative transition-colors duration-200 w-full">
            
            {/* LEFT: Sidebar List */}
            <div className={`flex flex-col bg-slate-50 relative shrink-0 h-full ${
                isMobile 
            ...
            {/* MIDDLE: Chat Room */}
            <div className={`flex flex-col bg-slate-50/30 relative shrink-0 h-full ${
                isMobile
                ...
                {activeChat ? (
                    ...
                    <div className="flex-1 h-full flex flex-col items-center justify-center gap-6 text-slate-400 bg-slate-50/50 w-full">
                        {isLoading ? (
